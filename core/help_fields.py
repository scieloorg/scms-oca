...
DIRECTORY_ACTION_HELP = env.str("DIRECTORY_ACTION_HELP", default=mark_safe(_('Determine qual a ação dessa prática: <a href="https://github.com/scieloorg/scms-oca/wiki/Campos#pr%C3%A1tica" target="_blank">https://github.com/scieloorg/scms-oca/wiki/Campos#acao</a>')))
...
DIRECTORY_AVAILABILITY_HELP = env.str("DIRECTORY_AVAILABILITY_HELP", default=mark_safe(_('Indique a disponibilidade: <a href="https://github.com/scieloorg/scms-oca/wiki/Campos#institui%C3%A7%C3%A3o-contribuidora" target="_blank">https://github.com/scieloorg/scms-oca/wiki/Campos#disponibilidade</a>')))
