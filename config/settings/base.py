...
ETL_ITEM_BULK_UPDATE_BATCH_SIZE = env.int("ETL_ITEM_BULK_UPDATE_BATCH_SIZE", 1000)
...
ETL_SILVER_BULK_MAX_DOCS = env.int("ETL_SILVER_BULK_MAX_DOCS", 1000)
ETL_SILVER_BULK_MAX_BYTES = env.int("ETL_SILVER_BULK_MAX_BYTES", 50 * 1024 * 1024)
