...
class DisclosureDirectoryHelper(ButtonHelper):
    ...
    def validate_button(self, obj):
        ...
        text = _("Validate")
        return {
            "url": reverse("disclosure_directory:validate") + "?file_id=%s" % str(obj.id),
            "label": text,
    ...
    def import_button(self, obj):
        ...
        text = _("Import")
        return {
            "url": reverse("disclosure_directory:import_file") + "?file_id=%s" % str(obj.id),
            "label": text,
