...
from .models import DisclosureDirectoryFile, DisclosureDirectory
...
def validate(request):
    ...
    if file_id:
        file_upload = get_object_or_404(DisclosureDirectoryFile, pk=file_id)
...
def download_sample(request):
    """
    This view function a CSV sample for model DisclosureDirectoryFile.
    """
    file_path = os.path.dirname(os.path.abspath(__file__)) + "/example_disclosure.csv"
