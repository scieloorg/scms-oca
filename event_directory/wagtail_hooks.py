...
class EventDirectoryAdmin(ModelAdmin):
    ...
    menu_label = _("Dissemination Data")
    menu_icon = "folder"
    menu_order = 100
    ...
    list_export = ("id", "get_title", "get_link", "get_description", "get_start_date", "get_end_date", "get_start_time", "get_end_time", "get_thematic_areas_level0", "get_thematic_areas_level1", "get_thematic_areas_level2", "get_keywords", "get_classification", "get_practice", "get_action", "get_source")
...
class EventDirectoryFileAdmin(ModelAdmin):
    ...
    menu_label = _("Dissemination Data Upload")
    menu_icon = "folder"
    menu_order = 200
