...
def validate(request):
    """
    Validate CSV file for EducationDirectory import.
    """
    format_file_path = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "chkcsvfmt.fmt"
    )
    return validate_directory_file(request, EducationDirectoryFile, format_file_path)
...
def download_sample(request):
    """
    Download CSV sample file for EducationDirectory import.
    """
    sample_file_path = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "example_education.csv"
    )
