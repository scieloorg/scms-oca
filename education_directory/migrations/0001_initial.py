    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='educationdirectoryfile_creator', to=settings.AUTH_USER_MODEL, verbose_name='Criador')),
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='educationdirectoryfile_last_mod_user', to=settings.AUTH_USER_MODEL, verbose_name='Atualizador')),
            ],
            options={
                'verbose_name_plural': 'Diretório de Educação Upload',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification', models.CharField(blank=True, choices=[('', ''), ('curso livre', 'curso livre'), ('disciplina de graduação', 'disciplina de graduação'), ('disciplina de lato sensu', 'disciplina de lato sensu'), ('disciplina de stricto sensu', 'disciplina de stricto sensu'), ('outros', 'outros')], max_length=255, null=True, verbose_name='Classificação')),
                ...
                ('creator', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='educationdirectory_creator', to=settings.AUTH_USER_MODEL, verbose_name='Criador')),
                ('institutions', models.ManyToManyField(blank=True, to='institution.Institution', verbose_name='Instituição')),
                ...
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='educationdirectory_last_mod_user', to=settings.AUTH_USER_MODEL, verbose_name='Atualizador')),
            ],
            options={
