    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='policydirectoryfile_creator', to=settings.AUTH_USER_MODEL, verbose_name='Criador')),
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='policydirectoryfile_last_mod_user', to=settings.AUTH_USER_MODEL, verbose_name='Atualizador')),
            ],
            options={
                'verbose_name_plural': 'Diretório de Política Upload',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, max_length=255, null=True, verbose_name='Data de início')),
                ('classification', models.CharField(blank=True, choices=[('', ''), ('promoção', 'promoção'), ('posicionamento', 'posicionamento'), ('mandato', 'mandato'), ('geral', 'geral')], max_length=255, null=True, verbose_name='Classificação')),
                ...
                ('creator', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='policydirectory_creator', to=settings.AUTH_USER_MODEL, verbose_name='Criador')),
                ...
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='policydirectory_last_mod_user', to=settings.AUTH_USER_MODEL, verbose_name='Atualizador')),
            ],
            options={
