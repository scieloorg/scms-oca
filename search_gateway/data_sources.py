...
DATA_SOURCES = {
    "world": {
        ...
        "field_settings": {
            ...
            "document_publication_year_start": {"transform": "year_range", "source_fields": ["document_publication_year_start", "document_publication_year_end"], "index_field_name": "publication_year"},
            "document_publication_year_end": {"transform": "year_range", "source_fields": ["document_publication_year_start", "document_publication_year_end"], "index_field_name": "publication_year"},
    ...
    "social": {
        ...
        "field_settings": {
            ...
            "document_publication_year_start": {"transform": "year_range", "source_fields": ["document_publication_year_start", "document_publication_year_end"], "index_field_name": "year"},
            "document_publication_year_end": {"transform": "year_range", "source_fields": ["document_publication_year_start", "document_publication_year_end"], "index_field_name": "year"},
    ...
    "journal_metrics": {
        ...
        "field_settings": {
            ...
            "journal_year_founded_start": {"transform": "year_range", "source_fields": ["journal_year_founded_start", "journal_year_founded_end"], "index_field_name": "year_of_creation_of_the_periodical"},
            "journal_year_founded_end": {"transform": "year_range", "source_fields": ["journal_year_founded_start", "journal_year_founded_end"], "index_field_name": "year_of_creation_of_the_periodical"},
            ...
            "journal_year_start": {"transform": "year_range", "source_fields": ["journal_year_start", "journal_year_end"], "index_field_name": "year"},
            "journal_year_end": {"transform": "year_range", "source_fields": ["journal_year_start", "journal_year_end"], "index_field_name": "year"},
