# Generated by Django 3.2.12 on 2023-01-10 14:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('usefulmodels', '0012_auto_20230105_1530'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rawarticle_creator', to=settings.AUTH_USER_MODEL, verbose_name='Criador')),
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rawarticle_last_mod_user', to=settings.AUTH_USER_MODEL, verbose_name='Atualizador')),
            ],
        ),
        migrations.AddIndex(
        ...
        migrations.AddField(
            model_name='commonpublicationdata',
            name='research_areas',
            field=models.ManyToManyField(blank=True, related_name='_provided_data_commonpublicationdata_research_areas_+', to='provided_data.CommonTextField', verbose_name='Research area'),
        ),
        migrations.AddField(
            model_name='commonpublicationdata',
            name='updated_by',
        ...
        migrations.AddField(
            model_name='authorship',
            name='citation_names',
            field=models.ManyToManyField(blank=True, related_name='_provided_data_authorship_citation_names_+', to='provided_data.CommonTextField', verbose_name='Citation name'),
        ),
        migrations.AddField(
            model_name='authorship',
            name='names',
            field=models.ManyToManyField(blank=True, to='provided_data.CommonTextField', verbose_name='Nome'),
        ),
        migrations.AddField(
            model_name='authorship',
            name='person_research_areas',
            field=models.ManyToManyField(blank=True, related_name='_provided_data_authorship_person_research_areas_+', to='provided_data.CommonTextField', verbose_name='Research area'),
        ),
        migrations.AddField(
            model_name='thesis',
            name='advisors',
