...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "post_date",
                    models.DateField(
                        blank=True, max_length=255, null=True, verbose_name="Post Date"
                    ),
                ),
                (
                    "authorship_post",
                    models.CharField(
                        ...
                        max_length=255,
                        null=True,
                        verbose_name="Authorship of the Post",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name="indicator",
            index=models.Index(
                fields=["action"], name="indicator_i_action__8f231a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="indicator",
            index=models.Index(
                fields=["practice"], name="indicator_i_practic_7b6df5_idx"
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="versioning_creator",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="versioning_last_mod_user",
                to=settings.AUTH_USER_MODEL,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="post_last_mod_user",
                to=settings.AUTH_USER_MODEL,
                verbose_name="Atualizador",
            ),
        ),
