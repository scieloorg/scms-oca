# Generated by Django 3.2.12 on 2022-09-27 12:55
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.DateField(
                blank=True, max_length=255, null=True, verbose_name="Data de fim"
            ),
        ),
        migrations.AddField(
            model_name="indicator",
            ...
            field=models.ManyToManyField(
                blank=True, to="institution.Institution", verbose_name="Instituição"
            ),
        ),
        migrations.AddField(
            model_name="indicator",
        ...
        migrations.AddField(
            ...
            name="locations",
            field=models.ManyToManyField(
                blank=True, to="location.Location", verbose_name="Localização"
            ),
        ),
        migrations.AddField(
            model_name="indicator",
        ...
        migrations.AddField(
            ...
            name="start_date",
            field=models.DateField(
                blank=True, max_length=255, null=True, verbose_name="Data de início"
            ),
        ),
        migrations.AddField(
            model_name="indicator",
            name="thematic_areas",
            field=models.ManyToManyField(
                blank=True, to="usefulmodels.ThematicArea", verbose_name="Área temática"
            ),
        ),
        migrations.AddField(
            model_name="indicator",
        ...
        migrations.AddIndex(
            model_name="indicator",
            index=models.Index(
                fields=["start_date"], name="indicator_i_start_d_618ee6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="indicator",
            index=models.Index(
                fields=["end_date"], name="indicator_i_end_dat_0cdcf7_idx"
            ),
        ),
