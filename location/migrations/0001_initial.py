# Generated by Django 3.2.12 on 2022-08-09 12:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('', ''), ('Norte', 'Norte'), ('Nordeste', 'Nordeste'), ('Centro-Oeste', 'Centro-Oeste'), ('Sudeste', 'Sudeste'), ('Sul', 'Sul')], max_length=255, verbose_name='Region')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usefulmodels.city', verbose_name='City')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usefulmodels.country', verbose_name='Country')),
                ...
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usefulmodels.state', verbose_name='State')),
