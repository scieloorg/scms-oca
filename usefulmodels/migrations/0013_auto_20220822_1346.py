...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('usefulmodels', '0012_auto_20220819_1331'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='thematicarea',
            name='level1',
            field=models.CharField(blank=True, choices=[('', ''), ('Ciências Agrárias', 'Ciências Agrárias'), ('Ciências Biológicas', 'Ciências Biológicas'), ('Ciências da Saúde', 'Ciências da Saúde'), ('Ciências Exatas e da Terra', 'Ciências Exatas e da Terra'), ('Ciências Humanas', 'Ciências Humanas'), ('Ciências Sociais Aplicadas', 'Ciências Sociais Aplicadas'), ('Engenharias', 'Engenharias'), ('Lingüística, Letras e Artes', 'Lingüística, Letras e Artes')], help_text='Here the thematic colleges of CAPES must be registered, more about these areas access: https://www.gov.br/capes/pt-br/acesso-a-informacao/acoes-e-programas/avaliacao/sobre-a-avaliacao/areas-avaliacao/sobre-as-areas-de-avaliacao', max_length=255, null=True, verbose_name='Nível 1'),
        ),
        migrations.AlterField(
            model_name='thematicarea',
            name='level2',
