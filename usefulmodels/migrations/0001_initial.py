# Generated by Django 3.2.12 on 2022-08-07 23:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=255, verbose_name='Name of the state')),
                ('acronym', models.CharField(blank=True, max_length=255, verbose_name='Acronym to the state')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Creation date')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Last update date')),
                ('name', models.CharField(blank=True, max_length=255, verbose_name='Name of the Country')),
                ('acronym', models.CharField(blank=True, max_length=255, verbose_name='Acronym to the Country')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Creation date')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Last update date')),
                ('name', models.CharField(blank=True, max_length=255, verbose_name='Name of the city')),
