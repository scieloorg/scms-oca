...
class PraticeFactory(DjangoModelFactory):
    ...
    name = factory.Iterator(["menção genérica à CA ou todas as práticas", "literatura em acesso aberto", "dados abertos de pesquisa",
                            "peer review aberto", "ciência cidadã", "recursos educacionais abertos", "outras práticas", ])
...
class ActionFactory(DjangoModelFactory):
    ...
    name = factory.Iterator(["políticas públicas e institucionais", "evolução da produção científica",
                            "infraestrutura", "educação / capacitação", "disseminação", "documentos", "outras", ])
